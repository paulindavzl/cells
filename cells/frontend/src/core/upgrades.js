...
export class AttributeUpgrade {
    ...
    allBuffs () {
        ...
        const buffs = [
            ...
            {"id": "1", "updateIn": "life", "attribute": "lifeRecovery", "text": "+<VALUE> health recovered per second", "type": ["absolute"], "absolute": [0.1, 2], "minLevel": 1, "rarity": 10, "rarityName": "common", "increment": "points"},
            ...
            {"id": "6", "updateIn": "DNA", "attribute": "DNAHarvesting", "text": "+<VALUE> DNA points and health recovery when harvesting", "type": ["absolute", "percent"], "percent": [5, 10], "absolute": [0.1, 1], "minLevel": 3, "rarity": 6, "rarityName": "rare", "increment": ""},
    ...
    allDebuffs () {
        ...
        const debuffs = [
            ...
            {"id": "1", "updateIn": "life", "attribute": "lifeRecovery", "text": "<VALUE> health recovered per second", "type": ["absolute"], "absolute": [-0.1, -5], "minLevel": 5, "rarity": 12, "rarityName": "common", "increment": "points"},
